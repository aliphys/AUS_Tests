...
const char testCaseID[] = "AUS_SPUSB_CRRLFS_001";
...
void setup()
{
  ...
  UFile file1 = root.createFile("file1.txt", FileMode::WRITE);
  UFile file2 = root.createFile("file2.txt", FileMode::WRITE);
  UFile file3 = root.createFile("file3.txt", FileMode::WRITE);
  UFile file4 = root.createFile("file4.txt", FileMode::WRITE);
  UFile file5 = root.createFile("file5.txt", FileMode::WRITE);
  ...
  std::vector<UFile> filesBefore = root.getFiles();
  // Print files
