...
const char testCaseID[] = "AUS_SPUSB_TXTBLFS_004";
...
void setup()
{
  ...
  crc.reset();
  Serial.println("testContent value: UDHRfa. With CRC value:" + String(testContentCRC8));

  const char testFilename[] = "UDHRfa.txt";
